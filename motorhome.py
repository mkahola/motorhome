...
#        self.showMaximized()
    ...
    def setup_ui(self):
        ...
        self.tempLabel.setStyleSheet("QLabel {color: white; font: bold 20px}")
        self.tempLabel.setAlignment(Qt.AlignRight)

        self.virbBattLabel = QLabel()
        self.virbBattLabel.setText(" -- %")
        self.virbBattLabel.setStyleSheet("QLabel {color: white; font: bold 20px}")
    ...
    def init_ruuvitag(self, page):
        ...
        outdoor.setStyleSheet("font: bold 28px;"
                              "color: white;")
        ...
        self.voltageLabel = QLabel("-- V")
        self.voltageLabel.setStyleSheet("font: 24px;"
                                        "color: white")
    ...
    def updateTemperature(self, temperature):
        ...
        self.tempLabel.setText("{:.1f}".format(temperature + 0.05) + " \u00b0C")
        self.temperatureLabel.setText("{:.2f}".format(temperature + 0.005) + " \u00b0C")

    def updateHumidity(self, humidity):
        self.humidityLabel.setText("{:.2f}".format(humidity) + " %")

    def updatePressure(self, pressure):
        self.pressureLabel.setText("{:.2f}".format(pressure) + " hPa")

    def updateRuuviBatt(self, voltage):
        self.voltageLabel.setText("{:.2f}".format(voltage/1000) + " V")
